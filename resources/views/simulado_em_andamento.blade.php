<x-layout :title="'Simulado - ' . ($cursoTitulo ?? 'Curso')">
    ...
    <div>
        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-left mt-7 mb-5" style="margin-left: 5%">
            {{ $cursoTitulo ?? 'Simulado' }}</h1>
            ...
            <div class="flex items-center gap-3 mb-5" style="margin-left: 5%">
                <div class="tooltip tooltip-right tooltip-info -mr-2">
                    <div class="tooltip-content rounded-xl outline -outline-offset-5 outline-dotted">
                        <p class="text-sm text-justify font-medium px-3 py-2">O <i>seed</i> é um código único que garante a
                            reprodução exata do
    ...
    <div class="fab lg:hidden">
        <button id="sidecard-toggle" class="btn btn-xl btn-circle btn-accent">
            <svg class="w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
